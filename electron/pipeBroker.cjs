...
const DEFAULT_TIMEOUT = 300_000; // 3 minutes per individual command call, plus a bit of leeway for startup/shutdown sequences. Wizard commands that expect multiple progress
